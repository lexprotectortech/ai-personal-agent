...
export const metadata: Metadata = {
	...
	description:
		"Connect WhatsApp, Gmail, Telegram, and Outlook to a unified AI Agent. Automate meeting summaries, smart drafts, task notifications, and daily digests in real-time.",
	keywords: [
		"AI Assistant",
		"WhatsApp AI",
		"Gmail AI",
