...
const SIMULATED_FEEDS: Record<string, FeedItem> = {
  whatsapp: {
    ...
    time: "Just now",
    originalText: "Abhijit: Hey guys, we need to finalize the landing page copy by tonight. Sarah, can you share your draft? Also, let's schedule a call tomorrow at 10 AM to sync up. I will review the logo mockups that Abhijit uploaded.",
    aiOutput: {
      summary: "Group sync regarding landing page copy finalization. Meeting proposed for tomorrow morning.",
      actionItems: [
      ...
      draftReply: "Sounds good, Sarah. Please send the link once ready. I'll block 10 AM tomorrow for the call!"
    }
  },
  gmail: {
    id: "gm-1",
    ...
    time: "5m ago",
    originalText: "Subject: Follow-up on Q3 Investment Deck\n\nHi team, thanks for sending over the deck. I reviewed the numbers on page 14 and they look solid. Could you send over the detailed financial sheet by Friday? If so, we can proceed with drafting the term sheet.",
    aiOutput: {
      summary: "Investor feedback on Q3 deck. Requesting detailed financials to proceed with the term sheet.",
      actionItems: [
        "Send detailed financial spreadsheet to David Harris (Due: Friday)"
      ],
      draftReply: "Hi David, glad you liked the deck. I will compile the detailed financials and send them over by Thursday morning. Thanks!"
    }
  },
  telegram: {
    id: "tg-1",
    ...
    time: "12m ago",
    originalText: "Mod_Ivan: ⚠️ Notice: The mainnet devnet upgrade is scheduled for June 30th at 14:00 UTC. Node operators must update to v1.18.15 to prevent desyncing. Detailed instructions are in the pinned blog post.",
    aiOutput: {
  ...
  outlook: {
    ...
    time: "30m ago",
    originalText: "Event Invite: Q3 Roadmap Alignment Session\nOrganizer: Elena Rostova\nTime: Tomorrow, 2:00 PM - 3:30 PM\nConflict: Overlaps with weekly design critique session.",
    aiOutput: {
      summary: "Calendar conflict detected for tomorrow afternoon between Q3 Roadmap Alignment and Weekly Design Critique.",
      actionItems: [
        "Resolve schedule overlap for tomorrow 2:00 PM",
        "Respond to Elena Rostova's invitation"
      ],
      draftReply: "Hi Elena, I have a conflict at 2 PM tomorrow with our design critique. Would 3:30 PM work instead, or should I delegate the design review?"
    }
  }
};
...
export default function LandingPage() {
  ...
  const [activeDeepDive, setActiveDeepDive] = useState<"whatsapp" | "gmail" | "telegram" | "outlook">("whatsapp");
  ...
  const faqs = [
    {
      ...
      answer: "OmniSync uses official OAuth 2.0 protocols for Gmail and Outlook, and secure API gateways for Telegram. For WhatsApp, we utilize safe business-level or personal sandbox endpoints. We never store your passwords; your authorization is handled token-by-token with fully revocable keys."
    },
    {
      question: "Does the AI read all my private messages?",
      answer: "No. You have absolute control. You can set filter configurations (e.g., 'Only analyze emails marked urgent', 'Only summarize WhatsApp group chats named Project Sync'). Processing is performed instantly and we do not store chat logs on our servers post-processing."
    },
    {
      question: "Can I customize what actions the AI takes?",
      answer: "Absolutely. You can define rules for each channel. For WhatsApp, you might want a 'TL;DR group digest at 6 PM daily'. For Gmail, you could configure it to 'Auto-draft friendly professional responses to clients' or 'Flag calendar invites that conflict with family time'."
    },
    {
      question: "Is my data secure?",
      answer: "Security is our highest priority. All raw data payload text processed by the AI is encrypted in transit and in memory using AES-256. We operate under SOC2 Type II guidelines. Your workspace information is never used to train public LLM models."
    },
    {
      question: "What is the setup time?",
      answer: "Under 2 minutes. Connecting a channel requires just a few clicks to authorize. Once connected, your personal agent begins syncing in the background instantly."
    }
  ];
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-[#030014] text-slate-900 dark:text-[#f8fafc] overflow-x-hidden transition-colors duration-300">
      ...
      <header className="sticky top-0 z-50 w-full glass-panel border-b border-slate-200/60 dark:border-white/5 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-3 group cursor-pointer">
            ...
            <span className="font-display font-bold text-xl tracking-tight text-slate-900 dark:text-white">
              OmniSync<span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">.AI</span>
            </span>
          </div>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#simulator" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors duration-200">
              Live Demo
            </a>
            <a href="#features" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors duration-200">
              Features
            </a>
            <a href="#integrations" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors duration-200">
              Integrations
            </a>
            <a href="#how-it-works" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors duration-200">
              How It Works
            </a>
            <a href="#faq" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors duration-200">
              FAQ
            </a>
          </nav>
            ...
            {loading ? (
              ...
              <div className="flex items-center space-x-4">
                <span className="text-sm text-slate-600 dark:text-slate-300">
                  Hi, <span className="font-semibold text-indigo-600 dark:text-indigo-400">{user.profile?.name || user.email.split('@')[0]}</span>
                </span>
                <Link
                  href="/dashboard"
              ...
              <>
                <Link href="/sign-in" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white transition-colors duration-200">
                  Sign In
                </Link>
                <Link
                  href="/sign-up"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden glass-panel border-b border-white/10 px-4 pt-2 pb-6 space-y-3 animate-in slide-in-from-top-4 duration-300">
            <a
              href="#simulator"
              ...
              {loading ? (
                ...
                <div className="flex flex-col space-y-2 px-3">
                  <span className="text-sm text-slate-300 text-center py-1">
                    Signed in as <span className="font-semibold text-indigo-400">{user.profile?.name || user.email}</span>
                  </span>
                  <Link
                    href="/dashboard"
                    onClick={() => setMobileMenuOpen(false)}
      ...
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-5xl mx-auto leading-tight sm:leading-none">
            ...
            <br />
            <span className="text-gradient-purple-blue">Synced With Your Digital Life.</span>
          </h1>

          {/* Description */}
          <p className="mt-6 text-base sm:text-lg md:text-xl text-slate-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Connect <strong className="text-slate-800 dark:text-slate-200">WhatsApp</strong>, <strong className="text-slate-800 dark:text-slate-200">Gmail</strong>, <strong className="text-slate-800 dark:text-slate-200">Telegram</strong>, and <strong className="text-slate-800 dark:text-slate-200">Outlook</strong> to an autonomous AI assistant. Let it generate actionable digests, draft answers, schedule reminders, and filter noise automatically.
          </p>
      ...
      <section id="simulator" className="py-16 md:py-24 relative border-t border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-slate-505 dark:text-slate-400">
              Toggle the messaging apps and email accounts on the left to see how your autonomous AI agent analyzes communication, generates summaries, schedules reminders, and drafts smart follow-ups.
            </p>
          </div>
            ...
            <div className="lg:col-span-5 flex flex-col space-y-4 justify-center">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className={`p-3 rounded-xl ${connections.whatsapp ? "bg-brand-whatsapp text-white" : "bg-slate-200 dark:bg-white/10 text-slate-500 dark:text-slate-400"}`}>
                      <MessageSquare className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 dark:text-slate-200">WhatsApp</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Group Chats & Personal Chats</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${connections.whatsapp ? "bg-brand-whatsapp/15 text-brand-whatsapp" : "bg-slate-200 dark:bg-white/5 text-slate-500"}`}>
                      {connections.whatsapp ? "Connected" : "Disconnected"}
                    </span>
                    <button 
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                        connections.whatsapp ? "bg-brand-whatsapp" : "bg-slate-200 dark:bg-white/10"
                      }`}
                    >
                      <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                        connections.whatsapp ? "translate-x-5" : "translate-x-0"
                      }`} />
                    </button>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className={`p-3 rounded-xl ${connections.gmail ? "bg-brand-gmail text-white" : "bg-slate-200 dark:bg-white/10 text-slate-500 dark:text-slate-400"}`}>
                      <Mail className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 dark:text-slate-200">Gmail</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Primary Inbox & Flagged</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${connections.gmail ? "bg-brand-gmail/15 text-brand-gmail font-semibold" : "bg-slate-200 dark:bg-white/5 text-slate-500"}`}>
                      {connections.gmail ? "Connected" : "Disconnected"}
                    </span>
                    <button 
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                        connections.gmail ? "bg-brand-gmail" : "bg-slate-200 dark:bg-white/10"
                      }`}
                    >
                      <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className={`p-3 rounded-xl ${connections.telegram ? "bg-brand-telegram text-white" : "bg-slate-200 dark:bg-white/10 text-slate-500 dark:text-slate-400"}`}>
                      <Send className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 dark:text-slate-200">Telegram</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Channels, Groups & Directs</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${connections.telegram ? "bg-brand-telegram/15 text-brand-telegram" : "bg-slate-200 dark:bg-white/5 text-slate-500"}`}>
                      {connections.telegram ? "Connected" : "Disconnected"}
                    </span>
                    <button 
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                        connections.telegram ? "bg-brand-telegram" : "bg-slate-200 dark:bg-white/10"
                      }`}
                    >
                      <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                        connections.telegram ? "translate-x-5" : "translate-x-0"
                      }`} />
                    </button>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className={`p-3 rounded-xl ${connections.outlook ? "bg-brand-outlook text-white" : "bg-slate-200 dark:bg-white/10 text-slate-500 dark:text-slate-400"}`}>
                      <Calendar className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 dark:text-slate-200">Outlook & Exchange</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Emails, Calendar & Tasks</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${connections.outlook ? "bg-brand-outlook/15 text-brand-outlook" : "bg-slate-200 dark:bg-white/5 text-slate-500"}`}>
                      {connections.outlook ? "Connected" : "Disconnected"}
                    </span>
                    <button 
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                        connections.outlook ? "bg-brand-outlook" : "bg-slate-200 dark:bg-white/10"
                      }`}
                    >
                      <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                        connections.outlook ? "translate-x-5" : "translate-x-0"
                      }`} />
                    </button>
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col justify-start overflow-y-auto space-y-6">
                  {activeSimFeed ? (
                    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-slate-500">{activeSimFeed.time}</span>
                        </div>
                        <div className="p-4 rounded-xl bg-slate-100/50 dark:bg-white/3 border border-slate-200 dark:border-white/5 flex items-start space-x-3">
                          <div className="mt-1">
                            {activeSimFeed.source === "whatsapp" && <MessageSquare className="w-4 h-4 text-brand-whatsapp" />}
                            {activeSimFeed.source === "gmail" && <Mail className="w-4 h-4 text-brand-gmail" />}
                            {activeSimFeed.source === "telegram" && <Send className="w-4 h-4 text-brand-telegram" />}
                            {activeSimFeed.source === "outlook" && <Calendar className="w-4 h-4 text-brand-outlook" />}
                          </div>
                          <div>
                            <p className="text-xs font-bold text-slate-800 dark:text-slate-200">{activeSimFeed.sender}</p>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 rounded-xl bg-purple-500/5 border border-purple-500/20">
                          ...
                          <ul className="mt-2 space-y-2">
                            {activeSimFeed.aiOutput.actionItems.map((item, index) => (
                              <li key={index} className="flex items-start text-xs text-slate-700 dark:text-slate-300">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                      ...
                      <h4 className="font-semibold text-slate-800 dark:text-slate-300">Workspace is Idle</h4>
                      <p className="text-sm text-slate-500 mt-2 max-w-sm">
                        Toggle one of the integrations on the left panel to active to watch the AI simulation parse incoming signals.
                      </p>
                    </div>
                  )}
                </div>
                    ...
                    <div className="flex space-x-2">
                      {Object.entries(connections)
                        ...
                        .map(([key]) => (
                          <button
                            key={key}
                            onClick={() => setActiveSimFeed(SIMULATED_FEEDS[key])}
      ...
      <section id="features" className="py-20 md:py-28 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-4 text-slate-505 dark:text-slate-400">
              OmniSync operates behind the scenes, connecting your communication stacks. Say goodbye to scattered messaging logs and manually setting alerts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="mt-3 text-sm text-slate-505 dark:text-slate-400 leading-relaxed">
                OmniSync automatically monitors texts like "Draft proposal by Friday" or "Schedule review tomorrow" and constructs action card templates automatically.
              </p>
            </div>
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="mt-3 text-sm text-slate-505 dark:text-slate-400 leading-relaxed">
                Eliminate spam. Program the agent to only focus on updates from key clients, project members, or specific keywords to protect your focus focus areas.
              </p>
            </div>
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="mt-3 text-sm text-slate-505 dark:text-slate-400 leading-relaxed">
                Draft emails and texts in your own personalized tone of voice. OmniSync analyzes historical communication records to draft tailored responses.
              </p>
            </div>
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="mt-3 text-sm text-slate-550 dark:text-slate-400 leading-relaxed">
                Get a clean daily summary sent straight to your WhatsApp or inbox every morning, showing what happened across channels and priority actions.
              </p>
            </div>
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="mt-3 text-sm text-slate-550 dark:text-slate-400 leading-relaxed">
                Your keys, your access. We implement end-to-end encrypted tunnels. Your private data is never retained, indexed, or shared with third-party providers.
              </p>
            </div>
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="mt-3 text-sm text-slate-550 dark:text-slate-400 leading-relaxed">
                Refer to Outlook calendars while answering client emails, or extract information from WhatsApp chats to construct task logs in real-time.
              </p>
            </div>
      ...
      <section id="integrations" className="py-20 md:py-28 bg-white/[0.01] border-y border-white/5 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-slate-505 dark:text-slate-400">
              Explore the dedicated capabilities of each connection. Switch tabs below to see how OmniSync adapts to each service.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-12">
            {[
              { id: "whatsapp", label: "WhatsApp Chat", icon: MessageSquare, color: "text-brand-whatsapp", border: "hover:border-brand-whatsapp/50" },
              { id: "gmail", label: "Gmail Workspace", icon: Mail, color: "text-brand-gmail", border: "hover:border-brand-gmail/50" },
              { id: "telegram", label: "Telegram Sync", icon: Send, color: "text-brand-telegram", border: "hover:border-brand-telegram/50" },
              { id: "outlook", label: "Outlook & Office", icon: Calendar, color: "text-brand-outlook", border: "hover:border-brand-outlook/50" }
            ].map(tab => (
              <button
                key={tab.id}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-in fade-in duration-300">
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                    Group chats move fast. OmniSync monitors designated WhatsApp chats, identifies decisions, pulls task commitments, and translates everything into structured bulletins.
                  </p>
                ...
                <div className="lg:col-span-5 bg-slate-100 dark:bg-white/2 border border-slate-200 dark:border-white/5 rounded-2xl p-6 relative overflow-hidden">
                  ...
                  <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-4">Sample Setup</h4>
                  <div className="space-y-4">
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-whatsapp">Rule 1: Focus Filter</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Only process chats containing keywords: #urgent, #task, #todo, #contract.</p>
                    </div>
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-whatsapp">Rule 2: Daily Digest</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Compile and send a daily TL;DR to my personal DM at 6:00 PM every evening.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeDeepDive === "gmail" && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-in fade-in duration-300">
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                    Keep your inbox clean. OmniSync reads incoming emails, references external contexts (e.g. your Telegram logs, WhatsApp agreements, or calendars) and drafts detailed replies in your specific tone of voice.
                  </p>
                  <ul className="space-y-3">
                    {[
                ...
                <div className="lg:col-span-5 bg-slate-100 dark:bg-white/2 border border-slate-200 dark:border-white/5 rounded-2xl p-6 relative overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-gmail">System Prompt Profile</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">"Always reply in a professional, brief, friendly tone. Refer to schedule details to verify availability."</p>
                    </div>
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-gmail">Smart Integration</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Cross-check calendar invites with Outlook to automatically resolve conflicts.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeDeepDive === "telegram" && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-in fade-in duration-300">
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                    For communities and development ecosystems running on Telegram, stay updated without getting lost. Parse key logs, release notifications, and team updates in real-time.
                  </p>
                  <ul className="space-y-3">
                    {[
                ...
                <div className="lg:col-span-5 bg-slate-100 dark:bg-white/2 border border-slate-200 dark:border-white/5 rounded-2xl p-6 relative overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-telegram">Channel Alerts</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Track key release tags: #announcement, #security, #critical, #upgrade.</p>
                    </div>
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-telegram">Task Auto-Push</p>
                      <p className="text-xs text-slate-505 dark:text-slate-400 mt-1">Send dev tasks directly to project trackers when milestone dates are identified.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-in fade-in duration-300">
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <p className="text-slate-505 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                    Avoid calendar overlaps. OmniSync tracks your calendar logs, identifies scheduling conflicts, and proposes draft replies or rescheduling alternatives instantly.
                  </p>
                  <ul className="space-y-3">
                    {[
                ...
                <div className="lg:col-span-5 bg-slate-100 dark:bg-white/2 border border-slate-200 dark:border-white/5 rounded-2xl p-6 relative overflow-hidden">
                  ...
                  <h4 className="text-xs font-bold text-slate-550 dark:text-slate-400 uppercase tracking-widest mb-4">Sample Setup</h4>
                  <div className="space-y-4">
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-outlook">Meeting Conflict Resolution</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">If conflict exists, draft tentative accept email asking for recording, or suggest a 30m slide.</p>
                    </div>
                    <div className="p-3 bg-white dark:bg-black/40 rounded-lg border border-slate-200 dark:border-white/5">
                      <p className="text-xs font-bold text-brand-outlook">Action Item Log</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Write key decisions from meeting invites to task timelines.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-4 text-slate-500 dark:text-slate-400">
              Get up and running in minutes. Connect your communication channels and let OmniSync automate the rest.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">Connect Accounts</h3>
              <p className="mt-3 text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
                Authorize OmniSync to connect with WhatsApp, Gmail, Telegram, or Outlook securely via OAuth or API tokens in a single click.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">Define AI Settings</h3>
              <p className="mt-3 text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
                Set priority rules, tone configurations, filters, digest schedules, and decide which keywords trigger automatic reminders.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">Autonomous Sync</h3>
              <p className="mt-3 text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
                The agent processes items in the background, drafting answers, setting logs, and alerting you when high-importance matters arrive.
              </p>
            </div>
      ...
      <section id="faq" className="py-20 md:py-28 border-t border-slate-200 dark:border-white/5 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-slate-500 dark:text-slate-400">
              Have questions about security, integrations, or customization? Find quick details here.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="glass-panel rounded-3xl border border-slate-200 dark:border-white/10 p-8 sm:p-12 md:p-16 text-center space-y-6 shadow-2xl relative">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
              Join thousands of developers, founders, and managers automating their communications. Get started today with no credit card required.
            </p>
            ...
            <div className="max-w-md mx-auto pt-4">
              ...
              <p className="text-[10px] text-slate-500 mt-3">
                By clicking "Connect Now", you agree to our Terms of Service & Privacy Policy.
              </p>
            </div>
      ...
      <footer className="bg-black/60 border-t border-white/5 py-12 md:py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
            ...
            <div className="col-span-2 space-y-4">
              ...
              <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
                OmniSync is a personal assistant AI agent platform that connects seamlessly to your secure communication channels, automating summaries, replies, and schedules.
              </p>
              <div className="flex items-center space-x-4 pt-2">
                {/* Simulated Social Links */}
                <a href="#" className="p-2 rounded-lg bg-white/3 border border-white/5 text-slate-400 hover:text-white transition-colors duration-200">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li><a href="#simulator" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Play Demo</a></li>
                <li><a href="#features" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Features Blueprint</a></li>
                <li><a href="#integrations" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">App Ecosystem</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Pricing Models</a></li>
              </ul>
            </div>

            {/* Integrations Links */}
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-slate-300 uppercase tracking-widest">Integrations</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">WhatsApp Sandbox</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Gmail OAuth</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Telegram Channels</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Microsoft Exchange</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">API Guidelines</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Security Audits</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">System Logs</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Help Center</a></li>
              </ul>
            </div>

            {/* Company Links */}
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-slate-300 uppercase tracking-widest">Company</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">About Us</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Contact Team</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Privacy Shield</a></li>
                <li><a href="#" className="text-xs text-slate-400 hover:text-white transition-colors duration-150">Legal Agreements</a></li>
              </ul>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-white/5 text-xs text-slate-500">
            <p>© {new Date().getFullYear()} OmniSync AI Inc. All rights reserved.</p>
